...
def _voice_attr(twilio_lang: str, voice_profile: str | None = None) -> str:
    voice = voice_profile or VOICE_BY_LANG.get(twilio_lang)
...
def build_greeting_twiml(
    ...
    voice = _voice_attr(twilio_language, voice_profile)
