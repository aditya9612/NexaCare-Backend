...
class NurseShiftCreate(BaseSchema):
    shift_name: str = Field(..., description="Name of the shift (e.g. Morning, Afternoon, Night)")
    ...
    status: str = Field("Scheduled", description="Status of the shift")
...
class NurseHandoverNoteCreate(BaseSchema):
    shift_id: int | None = Field(None, description="Optional linked shift ID")
    handover_date: date = Field(..., description="Date of the handover")
    summary: str = Field(..., description="Summary of the shift handover")
    ...
    status: str = Field("Active", description="Status of the handover note")
